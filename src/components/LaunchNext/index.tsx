...
interface ILaunchNextProps {
  launchData: ILaunchData;
}

export function LaunchNext({ launchData }: ILaunchNextProps) {
  ...
  return (
    <ContentSlider>
      <TextTitle>Launch Next</TextTitle>
      ...
      <Text>
        <strong>
          {launchData?.launch_success ? 'Mission Accomplished' : 'Not Released'}
        </strong>
      </Text>
